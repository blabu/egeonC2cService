...
func NewDecorator(p parser.Parser, s c2cData.DB, maxCONNECTION uint32, client client.ReadWriteCloser) client.ReadWriteCloser {
...
func (s *C2cDecorate) GetID() uint64 {
